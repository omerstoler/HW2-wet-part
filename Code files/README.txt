...
Update:
		...
		/kernel/sched.c -> all the logic and algorithms. need to get the understanding what to implement and where.
			...
			3) implementing a run_queue for SHORTs / check if it's possible to add just a "check for a fields result"
